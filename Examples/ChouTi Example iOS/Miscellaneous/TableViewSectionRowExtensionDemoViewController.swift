...
class TableViewSectionRowExtensionDemoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.sections?.append(
            TableViewSection(
                ...
                [
                    ...
                    TableViewRow(
                        title: "Cell with default Style (.Subtitle Style)",
        ...
        var section2 = TableViewSection(
            headerTitle: "I'm Section2 Header Text",
            rows:
            [
                TableViewRow(
                    title: "Customized Cell",
                    subtitle: "Subtitle...",
                    ...
                    cellConfiguration: { _, cell, _ -> Void in
