...
public protocol TextTableCollectionViewDataSource: AnyObject {
...
public protocol TextTableCollectionViewDelegate: AnyObject {
...
open class TextTableCollectionView: UICollectionView {
    ...
    open var titleFont = UIFont.italicSystemFont(ofSize: 17)
    open var contentFont = UIFont.systemFont(ofSize: 17)

    open var titleTextColor = UIColor(white: 0.5, alpha: 1.0)
    open var contentTextColor = UIColor(white: 0.5, alpha: 1.0)
...
extension TextTableCollectionView: TableLayoutDataSource {
    public func numberOfColumnsInTableLayout(_: TableCollectionViewLayout) -> Int {
        return textTableDataSource.numberOfColumnsInTableCollectionView(self)
    }

    public func tableLayout(_: TableCollectionViewLayout, numberOfRowsInColumn column: Int) -> Int {
        // + 1 for title
        return textTableDataSource.tableCollectionView(self, numberOfRowsInColumn: column) + 1
    }

    public func tableLayout(_: TableCollectionViewLayout, sizeForColumn column: Int, row: Int) -> CGSize {
...
extension TextTableCollectionView {
    private func configureLabel(_ label: UILabel, forColumn column: Int, row: Int) {
        if row == 0 {
