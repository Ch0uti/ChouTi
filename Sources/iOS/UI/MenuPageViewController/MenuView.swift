...
open class MenuView: UIView {
    ...
    private func setupConstraints() {
        ...
        constraints.append(menuCollectionView.topAnchor.constraint(equalTo: topAnchor))
        constraints.append(menuCollectionView.leadingAnchor.constraint(equalTo: leadingAnchor))
        constraints.append(menuCollectionView.bottomAnchor.constraint(equalTo: bottomAnchor))
        constraints.append(menuCollectionView.trailingAnchor.constraint(equalTo: trailingAnchor))
