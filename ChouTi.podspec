Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |ss|
    ...
    ss.subspec 'Extensions' do |sss|
      ...
      sss.subspec 'Foundation' do |ssss|
        ssss.source_files = 'ChouTi/Source/iOS/Core/Extensions/Foundation/**/*.*'
      end

      sss.subspec 'UI' do |ssss|
        ssss.source_files = 'ChouTi/Source/iOS/Core/Extensions/UI/**/*.*'
      end
  ...
  s.subspec 'UI' do |ss|
    ...
    ss.resource_bundle = { 'Resources' => 'ChouTi/Resources/**/*.png' }
    ss.dependency 'ChouTi/Core'
  ...
  s.subspec 'ThirdParty' do |ss|
    ...
    ss.subspec 'LoadingMorphingLabel' do |sss|
      ...
      sss.dependency 'LTMorphingLabel', '~> 0.5.8'
